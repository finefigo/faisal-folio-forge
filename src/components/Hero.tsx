...
const Hero = () => {
  ...
  return <section ref={heroSectionRef} className="min-h-[85vh] flex items-center justify-center py-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div className="flex flex-col md:flex-row items-center justify-between gap-8" variants={containerVariants} initial="hidden" animate="visible">
          {/* Text content */}
          <motion.div className="max-w-2xl text-center md:text-left" variants={itemVariants}>
            <motion.div variants={itemVariants} className="text-tech-teal font-mono text-lg mb-4">
              Hello, my name is
            </motion.div>
            
            <motion.h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-3" variants={itemVariants}>
              Faisal Imtiaz
            </motion.h1>
            
            <motion.h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-tech-slate mb-4 flex items-center justify-center md:justify-start" variants={itemVariants}>
            ...
            <motion.p className="text-tech-slate text-lg mb-8 mx-auto md:mx-0 max-w-xl text-balance" variants={itemVariants}>
          ...
          <motion.div variants={itemVariants} className="relative" whileHover={{
          scale: 1.05
        }} transition={{
          type: "spring",
          stiffness: 200,
          damping: 10
            ...
            {/* Profile image */}
            <motion.div className="relative w-56 h-56 sm:w-64 sm:h-64 rounded-full overflow-hidden border-4 border-tech-navy-light hover-glow transition-all duration-500" initial={{
            y: 20,
            opacity: 0
          }} animate={{
            y: 0,
